...
#Org1.crearOrganizacion("CONMEBOL", "America")
...
while(opcion != '8'):
    ...
    if(opcion == '1'):
        ...
        opcionOrg = input("1-CREAR ORGANIZACION \n 2-INSERTAR ORG. CREADA \n 3-VER ORGANIZACIONES DE LA BASE \n 4-MODIFICAR UNA ORGANIZACION \n 5-ELIMINAR UNA ORGANIZACION \n 6-VOLVER AL 1ER MENU \n OPCION: ")

        ORG = Organizacion()

        if(opcionOrg == '1'):

            nombre_org = input("\nEscriba el nombre de la organizacion: ")

            cont_org = input("\nEscriba el nombre del continente de la organizacion: ")
